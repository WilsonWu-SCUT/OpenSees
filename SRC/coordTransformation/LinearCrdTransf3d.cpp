...
bool LinearCrdTransf3d::setnodeOffset(const Vector& rigJntOffset, bool isI)
{
    // check rigid joint offset for node I
    if (&rigJntOffset == 0 || rigJntOffset.Size() != 3) {
        opserr << "LinearCrdTransf3d::LinearCrdTransf3d:  Invalid rigid joint offset vector for node " << (isI? "I": "J") << "\n";
